...
function Navbar() {
  return (
    <div>
      <nav className="navbar navbar-dark navbar-expand-xxl navbar-custom navbar-nav fluid-container navbar-background">
        <div className="navbar-brand ms-sm-3">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-linkedin mx-3" viewBox="0 0 16 16">
        ...
        <div className="offcanvas offcanvas-end align-items-end me-sm-3" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
          <ul className="navbar-nav">
            ...
            {routersettings.map((routerItem, index) => (
              <NavLink to={routerItem.redirect} key={index} className="navbar-font hover-color mx-3" activeClassName="active"  exact>
