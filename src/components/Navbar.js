            ...
            <div class="container-fluid">
              ...
              <div class="d-flex justify-content-center collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav navbar-font fs-3">
                  <button type='button' class='menu-button-wrapper fw-light'><a class="nav-link px-5" aria-current="page" href="home">about</a></button>
                  <button class='menu-button-wrapper fw-light'><a class="nav-link px-5" href='about'>experience</a></button>
                  <button class='menu-button-wrapper fw-light'><a class="nav-link active px-5" href='experience'>home</a></button>  
